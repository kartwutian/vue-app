...
; (function () {
    ...
    AlloyFinger.prototype = {
        ...
        move: function (evt) {
            ...
            //swipe
            // console.log(Math.abs(this.x1 - this.x2))
            // console.log(Math.abs(this.y1 - this.y2))
            ...
            } else if( ((this.x2 && Math.abs(this.x1 - this.x2) < 5) && (this.y2 && Math.abs(this.y1 - this.y2) < 5))||!this.x2||!this.y2){
